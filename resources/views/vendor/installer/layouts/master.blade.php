        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('install.finish') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('install.database') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('install.folders') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('install.server') }}">
